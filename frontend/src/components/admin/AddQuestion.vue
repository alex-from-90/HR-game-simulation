  ...
  <div class="container">
    ...
    <div class="form-group">
      ...
      <div class="answer-buttons">
        <button class="btn btn-primary" :class="{ 'btn-active': correctAnswer === true }" @click="setCorrectAnswer(true)">Правда</button>
        <button class="btn btn-danger" :class="{ 'btn-active': correctAnswer === false }" @click="setCorrectAnswer(false)">Ложь</button>
      </div>
    </div>
    <div class="form-group">
...
export default {
      ...
      if (this.mode === 'edit' && this.questionId) {
        QuestionDataService.getQuestionById(this.questionId)
            .then((response) => {
              ...
              this.chapterId = question.chapterId || this.$route.query.chapterId || null;
  ...
  mounted() {
    ...
    this.chapterId = this.$route.query.chapterId || null;
    if (this.mode === 'edit' && this.questionId) {
      this.loadQuestion();
